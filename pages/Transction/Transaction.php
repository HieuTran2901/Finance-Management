  ...
  <div class="flex min-h-screen">
    ...
    <aside class="w-64 bg-white shadow-md p-4">
      ...
      <nav class="space-y-3 text-gray-700">
        ...
        <a href="../Wallet/Wallet.php" class="flex items-center gap-2 p-2 hover:bg-gray-100 rounded-md">
          <i class="fa-solid fa-wallet"></i> Wallets
        </a>
        <a href="../Transction/Transaction.php" class="bg-gray-100 flex items-center gap-2 p-2 hover:bg-gray-100 rounded-md">
