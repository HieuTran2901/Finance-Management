...
<head>
    ...
    <style>
        ...
        tr:first-child th:first-child {
            border-top-left-radius: 0.75rem; /* rounded-xl on corners */
        }
        ...
        .overflow-x-auto::before, .overflow-x-auto::after {
            content: '';
            position: absolute;
            top: 0;
            bottom: 0;
        ...
        .overflow-x-auto::after {
            ...
            opacity: 1; /* Initially visible for right shadow */
        }
                ...
                <h1 class="text-2xl font-bold text-gray-800">Thông tin nhóm: <span class="text-emerald-600"><?= htmlspecialchars($group['name']) ?></span></h1>
                    ...
                    <div class="flex flex-wrap gap-3 mt-4 sm:mt-0 items-center">
                       ...
                       <a href="<?= $exit_link ?>" 
                            ...
                            <?= $is_fake_user ? 'onclick="return confirm(\'Bạn có chắc muốn thoát không?\')"' : '' ?>
                            >&times;</a>
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    ...
                                    <tr class="hover:bg-gray-50 transition-colors duration-150">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700">
                                            <?php
                                                if ($m['role'] === 'owner') { echo 'Nhóm trưởng'; }
                                                elseif ($m['role'] === 'owner_full') { echo 'Phó nhóm'; }
                                                elseif ($m['role'] === 'manager') { echo 'Quản lý chi tiêu'; }
